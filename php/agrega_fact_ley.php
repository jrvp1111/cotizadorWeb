...
switch($proceso){
	case 'Registro':
		mysql_query("INSERT INTO portalley (fecha_factley, emp_ley, num_fact_ley, ord_comp_ley, tipo_de_compra, tien_carg_ley, nomb_tiend_ley, num_entr_ley, fech_entr_ley, nomb_recibio, num_rem_ley, arriv_port_ley, fecha_reg_fact) VALUES ('$fechaFactLey', '$empreLey','$numFactLey', '$ordCompraLey', '$tipoCompraLey', '$tienCargoLey', '$nombTienLey', '$numEntrBultLey', '$fechEntrBultLey', '$nomQuienRecibLey', '$numRemLey', '$estPortLey', '$fecha')");
	break;
